...
class Platform:
    def __init__(self, color, x, y):
        ...
        self.double_width_breaking = self.width_breaking * 1.8
        self.double_height_breaking = self.height_breaking * 1.8
        ...
        if self.color == "green":
            ...
            self.width = self.width_breaking
            self.height = self.height_breaking
        else:
